...
@Entity
@Table(name = "stock_week_price", schema = "bstock", uniqueConstraints = @UniqueConstraint(columnNames = { "stock_code",
		"year", "weekofyear" }))
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
@IdClass(StockWeekPrice.StockWeekPriceId.class)
public class StockWeekPrice {
	...
	@AllArgsConstructor
	@Builder
	public static class StockWeekPriceId {
