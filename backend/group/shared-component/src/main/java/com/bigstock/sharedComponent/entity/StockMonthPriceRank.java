...
import com.bigstock.sharedComponent.entity.StockMonthPriceRank.StockMonthPriceRankId;
...
@NoArgsConstructor
@Entity
@Table(name = "stock_month_price_rank", schema = "bstock")
@IdClass(StockMonthPriceRankId.class)
public class StockMonthPriceRank {
	...
	@AllArgsConstructor
	@NoArgsConstructor
	public static class StockMonthPriceRankId {
		@Id
		@Column(name = "stock_code", nullable = false)
		private String stockCode;
