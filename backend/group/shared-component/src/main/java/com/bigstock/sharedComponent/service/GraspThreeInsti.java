...
//	@PostConstruct
	...
	public StockThreeInstitutionalTradingService.SyncResult updateThreeInstiManually(String yyyyMMdd) throws Exception {
		...
		List<ThreeInstitutionalTradingResponse> tpexThreeInstitutionalTradingResponses = ChromeDriverUtils
				.grabThreeInstiTpex(yyyyMMdd);
		SyncResult result = stockThreeInstitutionalTradingService.syncFromRedisToDb(yyyyMMdd, twseThreeInstitutionalTradingResponses,
				tpexThreeInstitutionalTradingResponses);
