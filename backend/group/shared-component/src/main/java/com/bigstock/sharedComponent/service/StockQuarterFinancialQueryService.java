...
public class StockQuarterFinancialQueryService {
    ...
    public List<QuarterlyFinancialResponse> queryByStockLatestN(String stockId, String market, int limit) {
    ...
    /**
     * 區間查：用 (year, quarter) 做範圍（用 seasonIndex = year*4 + quarter 轉換）
     */
